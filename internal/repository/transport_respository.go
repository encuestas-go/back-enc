...
func (t *TransportRespositoryService) GetMostUsedTransportReport(domain.ForTransportReport, error) {
	query := `
	...
	transportReport := []domain.ForTransportReport{}
	for rows.Next() {
		var report domain.ForTransportReport
